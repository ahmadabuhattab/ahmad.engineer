...
export function createWorldEnvironment(THREE, scene) {
  ...
  function update({ time = 0, scatter = 0, charge = 0, realm = 'energy', immersive = false, activity = null, warp = 0, collapse = 0, bloom = 0, visible = true } = {}) {
    if (disposed) return;
    world.visible = visible;
    if (!visible) { previousTime = time; return; }
