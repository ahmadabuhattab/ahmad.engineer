...
The share preview is `public/og-portfolio-2026.jpg` (1200 × 630). Hero artwork is served responsively: `public/observatory-living-2026.jpg` on desktop and `public/observatory-mobile-2026.jpg` on phones. These images are rendered from the actual portfolio scenes and appear before interactive rendering starts.
